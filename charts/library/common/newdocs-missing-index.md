# Newdocs Generator Full To-Do List

- [ ] Confirm generator completion target
  - Source docs files: **95**
  - Target newdocs files: **155**
  - Files with schema-backed gaps: **11**
  - Files with non-schema heading gaps: **92**
